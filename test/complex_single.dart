...
void main() {
  ...
  for (var x = -2.0; x <= 2.0; x += 0.5) {
    final result = complexF.complexCall({"x": Complex(x, 0)});
  ...
  final z = Complex(1, 1);
  final resultG = complexG.complexCall({"x": z});
  ...
  final resultH = complexH.complexCall({});
  ...
  final resultEuler = euler.complexCall({});
